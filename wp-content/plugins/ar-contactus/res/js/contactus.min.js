...
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties"object"==typeof globalThis&&globalThis,l,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var h=0;h<l.length;++h){var b=l[h];if(b&&b.Math==Math)return b}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
...
$jscomp.polyfill=function(l,h,b,q){h&&($jscomp.ISOLATE_POLYFILLS".");for(q=0;q<l.length-1;q++){var r=l[q];if(!(r in b))return;b=b[r]}l=l[l.length-1];q=b[l];h=h(q);h!=q&&null!=h&&$jscomp.defineProperty(b,l,{configurable:!0,writable:!0,value:h})};
$jscomp.polyfillIsolated=function(l,h,b,q){var r=l.split(".");l=1===r.length;q=r[0];q=!l&&q in $jscomp.polyfills"es6"===b?q[r]:null;h=h(b);null!=h&&(l?$jscomp.defineProperty($jscomp.polyfills,r,{configurable:!0,writable:!0,value:h}):h!==b&&(void 0===$jscomp.propertyToPolyfillSymbol[r]&&(b=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[r]=$jscomp.IS_SYMBOL_NATIVE"$"+r),$jscomp.defineProperty(q,$jscomp.propertyToPolyfillSymbol[r],{configurable:!0,writable:!0,value:h})))};$jscomp.initSymbol=function(){};
...
$jscomp.polyfill("Array.prototype.values",function(l){return l"es8","es3");
(function(l,h){"function"===typeof define&&define.amd"object"===typeof exports"undefined"!==typeof global"contactus",activated:!1,pluginVersion:"2.4.1",wordpressPluginVersion:!1,align:"right",mode:"regular",visible:!0,countdown:0,drag:!1,
...
backIcon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path fill="currentColor" d="M231.293 473.899l19.799-19.799c4.686-4.686 4.686-12.284 0-16.971L70.393 256 251.092 74.87c4.686-4.686 4.686-12.284 0-16.971L231.293 38.1c-4.686-4.686-12.284-4.686-16.971 0L4.908 247.515c-4.686 4.686-4.686 12.284 0 16.971L214.322 473.9c4.687 4.686 12.285 4.686 16.971-.001z" class=""></path></svg>',credits:!0,creditsUrl:"https://anychat.one",clickAway:!0,backdrop:!1,menuDirection:"vertical",
...
{classes:["arcu-menu-header-content","arcu-text-"+d.menuHeaderTextAlign]},d.menuHeaderText);if(d.menuHeaderIcon){var n=g("div",{classes:["arcu-header-icon"]});d.menuHeaderIcon.match(/^https'),f=g("div",{classes:["arcu-morph-shape"],id:"arcu-morph-shape","data-morph-open":"M-1,0h101c0,0,0-1,0,395c0,404,0,405,0,405H-1V0z"}),f.append(e),a.append(f)):"bubble"==d.style&&(e=t('<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 800" preserveAspectRatio="none"><path d="M-7.312,0H0c0,0,0,113.839,0,400c0,264.506,0,400,0,400h-7.312V0z"></path><defs></defs></svg>'),
...
(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector||Element.prototype.oMatchesSelector||Element.prototype.webkitMatchesSelector||function(f){f=(this.document||this.ownerDocument).querySelectorAll(f);for(var k=f.length;0<=--k&&f.item(k)!==this;);return-1<k});for(var e=[];a&&a!==document;a=a.parentNode)c".arcu-submenu-header").classList.add("active");
...
x=!1;d.iconsAnimationPause"arcontactus.closeMenu");b.dispatchEvent(a)}"elastic"!=d.style&&"bubble"!=d.style||setTimeout(function(){G.attr("d",U)},300)},ma=function(a){var c=b.querySelector(".arcu-prompt");a&&a.content&&(c.querySelector(".arcu-prompt-inner").innerHTML=a.content);c.classList.add("active");a=new Event("arcontactus.showPrompt");b.dispatchEvent(a)},Y=function(){b.querySelector(".arcu-prompt").classList.remove("active");
...
h.closeMenu=function(){return H()};h.toggleMenu=function(){Y();b.querySelector(".messangers-block").classList.contains(d.menuInAnimationClass)"arcontactus.toggleMenu");b.dispatchEvent(a)};h.showForm=function(a){return fa(a)};h.hideForm=function(){return X()};h.showPromptTyping=function(){b.querySelector(".arcu-prompt").querySelector(".arcu-prompt-inner").innerHTML="";var a=b.querySelector(".arcu-prompt-inner"),c=g("div",{classes:["arcu-prompt-typing"]}),e=g("div");c.append(e);
...
e.append(f);e.append(k);a.append(e)}a=void 0}else a=!1;return a};h.showWellcomeMessage=function(a){var c=b.querySelector(".arcu-wellcome");c".arcu-wellcome-msg.typing")&&(c.querySelector(".arcu-wellcome-msg.typing .arcu-wellcome-content").innerHTML=a.content,c.querySelector(".arcu-wellcome-msg.typing").classList.remove("typing")),a=void 0):a=!1;return a};h.openPopup=function(a){return ia(a)};h.closePopup=function(){return K()};h.showSubmenu=function(a){return ta(a)};h.hideSubmenu=
